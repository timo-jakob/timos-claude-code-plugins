...
| **development-go** | Go maintenance + review — core-loop tier (golangci-lint v2 format/lint) plus a 5-agent review panel; triage, coverage, bootstrap in later [#868](https://github.com/timo-jakob/timos-claude-code-plugins/issues/868) slices |
