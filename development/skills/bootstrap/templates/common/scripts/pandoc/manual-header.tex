...
% Included via --include-in-header from scripts/build-manuals.zsh; the PDF
% manual only, never the ePub.
...
%
% scripts/build-manuals.zsh fails the build on any REMAINING dropped character,
