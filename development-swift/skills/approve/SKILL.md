...
5. Spawn `swift-approver` agent, passing the token **file path** in the prompt.
...
## Step 5 — Invoke the swift-approver agent
...
One Fable invocation of `swift-approver` (~50–150 K tokens depending on
